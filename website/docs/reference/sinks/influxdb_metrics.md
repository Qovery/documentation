...
The Qovery `influxdb_metrics` sink
...
<Field
  ...
  defaultValue={null}
  enumValues={null}
  examples={["qovery-bucket","4d2225e4d3d49f75"]}
  groups={["v2"]}
  name={"bucket"}
  path={null}
  relevantWhen={null}
...
<Field
  ...
  defaultValue={null}
  enumValues={null}
  examples={["qovery-database","iot-store"]}
  groups={["v1"]}
  name={"database"}
  path={null}
  relevantWhen={null}
...
The following matrix outlines how Qovery metric types are mapped into InfluxDB Line Protocol fields.

| Qovery Metrics | Line Protocol Fields                             | Example                                                                                                                                                   |
|----------------|--------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
...
with the Qovery team by [opening an issue][urls.new_influxdb_metrics_sink_issue].
