...
You can check that your custom domain is well configured by executing the following command:
```
dig A www.your-custom-domain.com +short
```
You should retrieve in the `ANSWER SECTION` the default url configured by Qovery: zxxxxxxxx-zxxxxxxxx-gtw.zxxxxxxxx.qovery.cloud.
