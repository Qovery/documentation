...
The Qovery `regex_parser` transform
...
Qovery follows the [documented Rust Regex syntax][urls.rust_regex_syntax] since
Qovery is written in Rust. This syntax follows a Perl-style regular expression
...
[urls.regex_parsing_performance_test]: https://github.com/qovery/documentation-test-harness/tree/master/cases/regex_parsing_performance
