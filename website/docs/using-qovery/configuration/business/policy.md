...
[docs.using-qovery.configuration.business.build-platform.qovery-ci]: /docs/using-qovery/configuration/business/build-platform/qovery-ci/
...
[docs.using-qovery.configuration.business.policy#branch]: /docs/using-qovery/configuration/business/policy/#branch
