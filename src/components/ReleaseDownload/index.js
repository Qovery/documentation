...
function Downloads({browsePath, downloads}) {
    ...
    return (
        <ul className={styles.downloadFiles}>
                ...
                <li key={catIdx}>
                    ...
                    <ul>
                        {groupedDownloads[key].map((download, downloadIdx) => (
                            <li key={downloadIdx}>
                                <a key={downloadIdx} title={download.file_name} href={`https://packages.timber.io/qovery/${browsePath}/${download.file_name}`}>
            ...
            <li>
                <a href={`https://packages.timber.io/qovery/${browsePath}/`} target="_blank">browse all files&hellip;</a>
            </li>
        </ul>
    );
}
...
function ReleaseDownload({version}) {
    ...
    return (
        <Layout title="Download" description="Download Qovery for your platform.">
                            ...
                            <g id="Custom-Preset" transform="translate(-514.000000, -182.000000)">
                                <g id="Download" transform="translate(-340.000000, -479.000000)">
                                    <g id="Box" transform="translate(855.000000, 662.000000)">
                                        ...
                                        <g id="Qovery" transform="translate(17.608696, 16.304348)">
                        ...
                        <Tabs
                            ...
                            <TabItem value="older">
                                <Alert fill={true} type="warning">
                                    Olders versions are outdated and it is highly recommended to use the latest version. Please proceed with
                                    caution.
                                </Alert>
                                <Select
