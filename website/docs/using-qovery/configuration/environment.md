...
| Development      | Development environment is a working environment that could be used to develop and test new features and fixes. |
...
Note, Wildcards are not supported in the "Value" field (you can say Exclude all files ending with ".sh")
...
<div class="video-container">
  <p align="center">
    <iframe src="https://www.loom.com/embed/4642112b9f2846789fb0ba8fc14726b5" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen>
    </iframe>
  </p>
</div>
...
[docs.using-qovery.configuration.deployment-rule#project-deployment-rules]: /docs/using-qovery/configuration/deployment-rule/#project-deployment-rules
