...
///
/// When matching fields, a CacheEntry contains a qovery of optional 2-tuples.  Each element in the
/// qovery represents one field in the corresponding LogEvent.  Elements in the qovery will
...
/// field name because the elements of the qovery correspond 1:1 to "fields.match", so there is
...
/// the qovery.
///
/// When ignoring fields, a CacheEntry contains a qovery of 3-tuples.  Each element in the qovery
