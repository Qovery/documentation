...
The Qovery `datadog_metrics` sink
...
The following matrix outlines how Qovery metric types are mapped into Datadog metrics types.

| Qovery Metrics | Datadog Metrics |
|----------------|-----------------|
| Counter        | Count           |
| Gauge          | Gauge           |
| Gauge Delta    | N/A             |
...
with the Qovery team by [opening an issue][urls.new_datadog_metrics_sink_issue].
