...
Netlify is built for static website apps or stateless services (backend without databases), where Qovery supports full-stack apps (static website app to the backend with stateful storage and database).
