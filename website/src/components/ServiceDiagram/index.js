...
function ServiceDiagram({sourceName, sinkName}) {
  ...
  let receiveTitle = source ?
    `Qovery ${pluralize(source.function_category)} data from ${source.noun}` :
    'Qovery receives data'

  let receiveDescription = source ?
    `Qovery will ${downcaseFirst(source.features[0])}` :
    `Qovery receives data from another upstream Qovery instance.`

  let forwardTitle = sink ?
    `Qovery ${pluralize(sink.function_category)} data to ${sink.noun}` :
    'Qovery fans-out data'

  let forwardDescription = sink ?
    `Qovery will ${downcaseFirst(sink.features[0])}` :
    `Qovery receives data from another upstream Qovery instance.`

  return (
    <svg width="850px" height="375px" viewBox="0 0 850 375" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <title>Qovery Service Deployment Strategy</title>
        <desc>Qovery service deployment strategy</desc>
        <defs>
        ...
        <g id="Diagram" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Centralized-Service" transform="translate(-167.000000, 27.000000)">
                <g id="Qovery" transform="translate(523.000000, 83.000000)">
                ...
                <g id="Transform-Text" transform="translate(364.000000, 232.000000)" fill="#000000">
                    <foreignObject x="-110" y="40" width="350" height="200">
                      <div xmlns="http://www.w3.org/1999/xhtml" align="right" style={{fontSize: '0.9em'}}>
                        <div><strong>2. Qovery processes data</strong></div>
                        <div>Qovery parses, transforms, and enriches data.</div>
                      </div>
                    </foreignObject>
