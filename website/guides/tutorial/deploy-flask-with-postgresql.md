...
description: How to deploy a Flask application with the PostgreSQL database on AWS with Qovery
...
This tutorial show you how to deploy your [Flask][urls.node_js] application with [PostgreSQL][urls.postgresql] database on [AWS][urls.aws]. Let's go!
...
## Steps to deploy Flask on AWS with Qovery
...
Get a local copy of the [Flask sample project][urls.sample_flask_with_postgresql] by forking it.

### Configure your project
To deploy your Flask application connected to a PostgreSQL, you need to have a `.qovery.yml` file, and a `Dockerfile` (both provided in the sample project) at the root of your project.
...
## Conclusion
Congratulations! Now, you know how to deploy your Flask app with PostgreSQL on AWS in just a few steps.
