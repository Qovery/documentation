...
Daily backups for your MySQL database are automatically done for [Production environments][docs.using-qovery.configuration.deployment-rule#environment-mode].
