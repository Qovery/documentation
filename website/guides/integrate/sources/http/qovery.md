...
description: "A simple guide to send logs from HTTP to another Qovery instance in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Qovery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: qovery"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to another Qovery instance
...
<!--
     ...
     website/guides/integrate/sources/http/qovery.md.erb
-->
