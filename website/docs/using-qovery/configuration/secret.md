...
Qovery makes **Secrets** available to your services at runtime, as well as during builds and deploys.
...
You can only override secrets of a highet scope, e.g. **Environment** scope variable can override **Project** variable, but can't override **Application** variable.
