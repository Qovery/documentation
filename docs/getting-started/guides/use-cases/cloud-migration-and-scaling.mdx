...
<CardGroup cols={3}>
  <Card title="AI-Powered Migration" icon="wand-magic-sparkles">
    The `/qovery-onboard` AI skill maps your current platform's concepts to Qovery, then analyzes your codebase, creates Dockerfiles, provisions databases, and deploys - all from a single prompt
  </Card>
...
<Steps>
  ...
  <Step title="Ask the Agent to Migrate">
    ...
    The `qovery-onboard` skill acts as your personal cloud architect. It will guide you through the entire process:
