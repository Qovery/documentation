...
<Warning>
  This feature requires the **VPCGatewayFullAccess** IAM permission set in addition to the standard Qovery permissions. Make sure it is added to your Qovery IAM policy before enabling this option. See the [Scaleway IAM Permissions Reference](/getting-started/security-and-compliance/scaleway-iam-permissions#vpcgatewayfullaccess--static-ip-for-egress-traffic) for details.
</Warning>
