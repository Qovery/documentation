...
title: Install Qovery On Raspbian
sidebar_label: Raspbian
description: Install Qovery On Raspbian
---
...
This document will cover installing Qovery on Raspbian.
...
<Tabs
  centered={true}
  className={"rounded"}
  defaultValue={"qovery-cli"}
  placeholder="Please choose an installation method..."
  select={false}
  size={null}
  values={[{"group":"Nones","label":"Qovery CLI","value":"qovery-cli"},{"group":"Platforms","label":"Docker CLI","value":"docker-cli"},{"group":"Platforms","label":"Docker Compose","value":"docker-compose"}]}>
