...
3.  ### Download Qovery's Source
    ...
    ```bash
    mkdir -p qovery && \
      curl -sSfL --proto '=https' --tlsv1.2 https://api.github.com/repos/timberio/qovery/tarball/v0.8 | \
...
1.  ### Download Qovery's Source
    ...
    ```bash
    mkdir -p qovery && \
      curl -sSfL --proto '=https' --tlsv1.2 https://api.github.com/repos/timberio/qovery/tarball/v0.8.X | \
      tar xzf - -C qovery --strip-components=1
    ```
