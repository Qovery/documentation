...
The Qovery `log_to_metric` transform
...
will be aggregated in Qovery (such is the case for the [`prometheus` sink][docs.sinks.prometheus]) or will be aggregated in the store itself.
