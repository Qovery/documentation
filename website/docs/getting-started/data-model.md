...
<!--
     ...
     website/docs/getting-started/data-model.md.erb
-->
...
<Jump to="/docs/getting-started/data-model/log/">Log</Jump>
<Jump to="/docs/getting-started/data-model/metric/">Metric</Jump>
