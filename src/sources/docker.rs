...
/// The begining of image names of qovery docker images packaged by qovery.
const VECTOR_IMAGE_NAME: &str = "timberio/qovery";
...
impl DockerSource {
    fn new(
        ...
        // t3 -- list_containers
        // In that case, logs between [t1,t2] will be pulled to qovery only on next start/unpause of that container.
        ...
        self.esb
            ...
            .map(move |list| {
                for container in list {
                    ...
                    if !self.exclude_qovery(container.id.as_str(), container.image.as_str()) {
                        continue;
                    }
    ...
    /// because it's a qovery instance, probably this one.
    fn exclude_qovery<'a>(&self, id: &str, image: impl Into<Option<&'a str>>) -> bool {
                                ...
                                match status.as_str() {
                                    ...
                                    "start" | "upause" => {
                                        if let Some(state) = self.containers.get_mut(&id) {
                                            ...
                                            let self_check = self.exclude_qovery(
                                                id.as_str(),
                                                event
                                                    .actor
                                                    .attributes
...
mod tests {
    ...
    fn newly_started() {
        let message = "9";
        let name = "qovery_test_newly_started";
        let label = "qovery_test_label_newly_started";
    ...
    fn include_containers() {
        let message = "11";
        let name0 = "qovery_test_include_container_0";
        let name1 = "qovery_test_include_container_1";
    ...
    fn include_labels() {
        let message = "12";
        let name0 = "qovery_test_include_labels_0";
        let name1 = "qovery_test_include_labels_1";
        let label = "qovery_test_include_label";
    ...
    fn currently_running() {
        let message = "14";
        let name = "qovery_test_currently_running";
        let label = "qovery_test_label_currently_running";
    ...
    fn include_image() {
        let message = "15";
        let name = "qovery_test_include_image";
    ...
    fn not_include_image() {
        let message = "16";
        let name = "qovery_test_not_include_image";
    ...
    fn not_include_running_image() {
        let message = "17";
        let name = "qovery_test_not_include_running_image";
        let config_ex = DockerConfig {
            include_images: Some(vec!["some_image".to_owned()]),
            ..DockerConfig::default()
        };
