...
The CIDR range of the Qovery VCP is the one you selected at the creation of the cluster. 
...
You can find the CIDR ranges of the existing VPC in the AWS console.
...
<p align="center">
    <img src="/img/aws-vpc-peering-with-qovery/existing-rt.png" alt="AWS VPC Route Table" />
</p>    
