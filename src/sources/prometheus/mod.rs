...
mod test {
    ...
    fn test_prometheus_routing() {
        ...
        assert_eq!(lines, vec![
            "# HELP qovery_promhttp_metric_handler_requests_total promhttp_metric_handler_requests_total",
            "# TYPE qovery_promhttp_metric_handler_requests_total counter",
            "qovery_promhttp_metric_handler_requests_total{code=\"200\"} 100",
            "qovery_promhttp_metric_handler_requests_total{code=\"404\"} 7",
            "# HELP qovery_prometheus_remote_storage_samples_in_total prometheus_remote_storage_samples_in_total",
            "# TYPE qovery_prometheus_remote_storage_samples_in_total gauge",
            "qovery_prometheus_remote_storage_samples_in_total 57011636",
            "# HELP qovery_http_request_duration_seconds http_request_duration_seconds",
            "# TYPE qovery_http_request_duration_seconds histogram",
            "qovery_http_request_duration_seconds_bucket{le=\"0.05\"} 24054",
            "qovery_http_request_duration_seconds_bucket{le=\"0.1\"} 33444",
            "qovery_http_request_duration_seconds_bucket{le=\"0.2\"} 100392",
            "qovery_http_request_duration_seconds_bucket{le=\"0.5\"} 129389",
            "qovery_http_request_duration_seconds_bucket{le=\"1\"} 133988",
            "qovery_http_request_duration_seconds_bucket{le=\"+Inf\"} 144320",
            "qovery_http_request_duration_seconds_sum 53423",
            "qovery_http_request_duration_seconds_count 144320",
            "# HELP qovery_rpc_duration_seconds rpc_duration_seconds",
            "# TYPE qovery_rpc_duration_seconds summary",
            "qovery_rpc_duration_seconds{code=\"200\",quantile=\"0.01\"} 3102",
            "qovery_rpc_duration_seconds{code=\"200\",quantile=\"0.05\"} 3272",
            "qovery_rpc_duration_seconds{code=\"200\",quantile=\"0.5\"} 4773",
            "qovery_rpc_duration_seconds{code=\"200\",quantile=\"0.9\"} 9001",
            "qovery_rpc_duration_seconds{code=\"200\",quantile=\"0.99\"} 76656",
            "qovery_rpc_duration_seconds_sum{code=\"200\"} 17560473",
            "qovery_rpc_duration_seconds_count{code=\"200\"} 2693",
            ],
        );
