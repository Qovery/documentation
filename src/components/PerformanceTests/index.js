...
function RowDescription({test}) {
    return (
        <td className="description">
            ...
            <div className="links">
                <div>
                    <a href={`https://github.com/qovery/documentation-test-harness/tree/master/cases/${test.slug}`} target="_blank">
    ...
    useEffect(() => {
        async function fetchData() {
            const result = await axios(
                `https://test-results.qovery.dev/summaries/latest.json`,
            );
