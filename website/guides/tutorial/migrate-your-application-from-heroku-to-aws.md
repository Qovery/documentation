...
description: Guide on how to migrate your application from Heroku to AWS with a PostgreSQL database
...
Qovery makes the difference between an [Environment Variable][docs.using-qovery.configuration.environment-variable] and a [Secret][docs.using-qovery.configuration.secret]. Basically, a Secret is similar to an Environment Variable but the value is encrypted and can't be revealed. Both are injected as environment variables during the build and the run of your applications.
...
Check out the [app rollback documentation][docs.using-qovery.configuration.application#update-and-rollback]
...
[docs.using-qovery.configuration.application#update-and-rollback]: /docs/using-qovery/configuration/application/#update-and-rollback
