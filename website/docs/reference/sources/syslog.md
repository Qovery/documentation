...
issues_url: https://github.com/qovery/documentation/issues?q=is%3Aopen+is%3Aissue+label%3A%22source%3A+syslog%22
operating_systems: ["Linux","MacOS","Windows"]
sidebar_label: "syslog|[\"log\"]"
source_url: https://github.com/qovery/documentation/tree/master/src/sources/syslog.rs
status: "prod-ready"
title: "Syslog Source"
...
Qovery will use the upstream hostname. In the case where [`mode`](#mode) = `"unix"` the
...
then Qovery will use the current time.
...
Qovery makes a _best effort_ to parse the various Syslog formats out in the
...
Qovery insulates you from these diviations.

If parsing fails, Qovery will include the entire Syslog line in the [`message`](#message)
