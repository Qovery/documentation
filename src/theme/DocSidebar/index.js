    ...
    switch (type) {
        ...
        default:
            ...
            return (
                ...
                {eventTypes.includes("log") &&
                <span className="badge badge--secondary" title="This component works with log events.">L</span>}
                            {eventTypes.includes("metric") &&
                            <span className="badge badge--secondary" title="This component works with metric events.">M</span>}
              </span>}
                    </Link>
                </li>
            );
