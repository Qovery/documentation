...
const features = [
    {
        ...
        description: (
            <>
                Built in <a href="https://www.rust-lang.org/">Rust</a>, Qovery is <a href="#performance">blistering fast and
    ...
    },
    {
        ...
        description: (
            <>
                Qovery does not favor any storage and fosters a fair, open ecosystem with your best interest in mind. Lock-in free and
                future proof.
            </>
        ),
    },
    {
        ...
        description: (
            <>
                Qovery aims to be the single, and only, tool needed to get data from A to
                B, <Link to="/docs/setup/deployment/">deploying</Link> as
                an <Link to="/docs/setup/deployment/strategies/#daemon">daemon</Link>, <Link to="/docs/setup/deployment/strategies/#sidecar">sidecar</Link>,
                or <Link to="/docs/setup/deployment/strategies/#service">service</Link>.
            </>
        ),
    },
    {
        ...
        description: (
            <>
                Qovery supports <Link to="/docs/about/data-model/log/">logs</Link>, <Link to="/docs/about/data-model/metric/">metrics</Link>,
                and <Link to="/docs/about/data-model/#event">events</Link>, making it easy to collect and process <i>all</i> observability
                data.
            </>
        ),
    },
    {
        ...
        description: (
            <>
                <Link to="/components/?functions[]=program">Programmable transforms</Link> give you the full power of programmable runtimes.
                Handle complex use cases without limitation.
            </>
        ),
    },
    {
        ...
        description: (
            <>
                Guarantees matter, and Qovery is <Link to="/docs/about/guarantees/">clear on it's guarantees</Link>, helping you to make the
                appropriate trade offs for your use case.
            </>
        ),
    },
];
    ...
    return (
        <section className={styles.features}>
            <div className="container">
                <AnchoredH2 id="features">Why Qovery?</AnchoredH2>
                {rows}
            </div>
        </section>
    );
                    ...
                    <table className="comparison">
                        ...
                        <tr>
                            <td className="row-label">
                                <a target="_blank" href="https://github.com/qovery/documentation-test-harness/tree/master/cases/disk_buffer_persistence_correctness">Disk
                                    buffer persistence</a></td>
                        ...
                        <tr>
                            <td className="row-label">
                                <a target="_blank" href="https://github.com/qovery/documentation-test-harness/tree/master/cases/file_rotate_create_correctness">File
                                    rotate (create)</a></td>
                            <td className="result passed qovery"><i className="feather icon-check"></i></td>
                            <td className="result passed"><i className="feather icon-check"></i></td>
                            <td className="result passed"><i className="feather icon-check"></i></td>
                        ...
                        <tr>
                            <td className="row-label">
                                <a target="_blank" href="https://github.com/qovery/documentation-test-harness/tree/master/cases/file_rotate_truncate_correctness">File
                                    rotate (copytruncate)</a></td>
                            <td className="result passed qovery"><i className="feather icon-check"></i></td>
                            <td className="result failed"><i className="feather icon-x"></i></td>
                            <td className="result failed"><i className="feather icon-x"></i></td>
                            <td className="result failed"><i className="feather icon-x"></i></td>
                        ...
                        <tr>
                            <td className="row-label">
                                <a target="_blank" href="https://github.com/qovery/documentation-test-harness/tree/master/cases/file_truncate_correctness">File
                                    truncation</a></td>
                            <td className="result passed qovery"><i className="feather icon-check"></i></td>
                            <td className="result passed"><i className="feather icon-check"></i></td>
                            <td className="result passed"><i className="feather icon-check"></i></td>
                        ...
                        <tr>
                            <td className="row-label">
                                <a target="_blank" href="https://github.com/qovery/documentation-test-harness/tree/master/cases/sighup_correctness">Process
                                    (SIGHUP)</a></td>
                            <td className="result passed qovery"><i className="feather icon-check"></i></td>
                            <td className="result failed"><i className="feather icon-x"></i></td>
                            <td className="result failed"><i className="feather icon-x"></i></td>
                        ...
                        <tr>
                            <td className="row-label">
                                <a target="_blank" href="https://github.com/qovery/documentation-test-harness/tree/master/cases/tcp_stream_correctness">TCP
                                    Streaming</a></td>
                            <td className="result passed qovery"><i className="feather icon-check"></i></td>
                            <td className="result failed"><i className="feather icon-x"></i></td>
                            <td className="result failed"><i className="feather icon-x"></i></td>
                        ...
                        <tr>
                            <td className="row-label">
                                <a target="_blank" href="https://github.com/qovery/documentation-test-harness/tree/master/cases/wrapped_json_correctness">JSON
                                    (wrapped)</a></td>
                            <td className="result passed qovery"><i className="feather icon-check"></i></td>
                            <td className="result passed"><i className="feather icon-check"></i></td>
                            <td className="result failed"><i className="feather icon-x"></i></td>
                ...
                <div className={classnames(styles.components, 'components')}>
                    ...
                    <ul>
                        {Object.keys(sources).map((key, index) => (
                            <li className={classes[`${key}_source`]} key={index}>
                                <Link to={`/docs/reference/sources/${key}/`}>{sources[key].name}</Link></li>
                        ))}
                        {Object.keys(transforms).map((key, index) => (
                            <li className={classes[`${key}_transform`]} key={index}>
                                <Link to={`/docs/reference/transforms/${key}/`}>{transforms[key].name}</Link></li>
                        ))}
                        {Object.keys(sinks).map((key, index) => (
                            <li className={classes[`${key}_sink`]} key={index}>
                                <Link to={`/docs/reference/sinks/${key}/`}>{sinks[key].name}</Link></li>
                        ))}
                    </ul>
                </div>
            </div>
            ...
            <header className={classnames('hero', 'hero--full-height', styles.indexHeroBanner)}>
                <div className="container container--fluid">
                    ...
                    <p className="hero--subtitle">
                        <Link to="/components/">Collect, transform, &amp; route</Link> <i>all</i> observability data with <i>one</i> simple
                        tool.
                    </p>
                    <div className="hero--buttons">
                        <Link to="https://github.com/qovery/documentation/" className="button button--primary"><i className="feather icon-github"></i> View
                            on Github</Link>
                    ...
                    <p className="hero--subsubtitle">
                        Qovery is <strong><em>deployed over 100,000 times per day</em></strong> by Fortune 500 companies and startups.
                    </p>
                </div>
            </header>
            <main>
