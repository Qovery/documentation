...
<!--
     ...
     website/docs/getting-started/basic-concepts.md.erb
-->
...
Your production environment runs 24/7 while your other environments may not need to run all day long. By setting a [Deployment Rule][docs.using-qovery.configuration.deployment-rule] on your environment you can automatically start/stop your non-production environments and thus reduce your cloud provider bill.
...
- Application: it allows you to run your long-running workloads on your Kubernetes cluster. It can be deployed from a git repository or as a contaienr from an image registry. More information about [Applications here][docs.using-qovery.configuration.application]
...
- Helm: it allows you to deploy a helm chart on your Kuberenetes cluster. More information about [Helm here][docs.using-qovery.configuration.helm]
