use crate::{
    event::proto,
    internal_events::QoveryEventSent,
...
pub struct QoverySinkConfig {
    pub address: String,
    pub tls: Option<TlsConfig>,
}

impl QoverySinkConfig {
...
inventory::submit! {
    SinkDescription::new_without_default::<QoverySinkConfig>("qovery")
}

#[typetag::serde(name = "qovery")]
impl SinkConfig for QoverySinkConfig {
