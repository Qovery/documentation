...
To follow the guide, <a href="urls.sample_django_with_postgresql">you can fork and use our repository</a>
...
*TIP: you could also make use of **Variable Aliases** to change the name of used environment variables in your Django application. [Learn more here][docs.using-qovery.configuration.environment-variable#alias-environment-variable].*
...
[urls.sample_django_with_postgresql_env_file]: https://github.com/Qovery/simple-example-django-with-postgresql/blob/master/example/project/settings.py
