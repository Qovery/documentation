...
title: Metric Event
description: A detailed guide on Qovery's internal metric data model.
---
...
the schema of the metric structure within Qovery.
...
Qovery's internal gauge type represents changes to that value. Gauges should be
