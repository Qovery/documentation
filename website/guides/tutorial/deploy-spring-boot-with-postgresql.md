...
description: How to deploy a Spring Boot application with the PostgreSQL database on AWS with Qovery
...
This tutorial show you how to deploy your [Spring Boot][urls.spring_boot] application with [PostgreSQL][urls.postgresql] database on [AWS][urls.aws]. Let's go!
...
## Steps to deploy Spring Boot on AWS with Qovery
...
Get a local copy of the [Spring Boot sample project][urls.sample_spring_boot_with_postgresql] by forking it.
...
## Conclusion
Congratulations! Now, you know how to deploy your Spring Boot app with PostgreSQL on AWS in just a few steps.
