...
When running your application, you will typically use a set of environment variables to capture the configuration of the application. For example: say your app uses S3 for image storage. You would want to store the credentials to S3 as environment variable.
...
* Environment variable data (the combination of all keys and values) cannot exceed 32kb for each app.
