...
Blueprints come from four sources, and the source decides what the resource runs on and how it authenticates.
...
<Warning>
**Migration is not self-service.** It is run by the Qovery team together with you. To start one, [contact our team](https://www.qovery.com/contact) or reach out directly in the product (help button in the Console, or your dedicated Slack channel).
</Warning>
...
| Database engine | PostgreSQL. MySQL is not wired yet. |
