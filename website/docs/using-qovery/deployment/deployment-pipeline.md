...
```bash
qovery environment stage edit -n <name> -d <description>
```
...
[docs.using-qovery.deployment.deployment-pipeline#change-stage-for-a-service]: /docs/using-qovery/deployment/deployment-pipeline/#change-stage-for-a-service
