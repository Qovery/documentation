...
<CardGroup cols={2}>
  ...
  <Card title="Migrate to Kubernetes" icon="cloud-arrow-up" href="/getting-started/guides/use-cases/cloud-migration-and-scaling">
    Leave Heroku, Render, or Railway. An AI agent migrates your apps to Kubernetes on your own cloud.

    **~1 day** · No re-architecture required
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Test & Learn Locally" icon="flask" href="/getting-started/quickstart/docker">
