...
tags: ["type: tutorial", "framework: jhipster", "language: java", "database: postgresql"]
...
This tutorial show you how to deploy your [JHipster][urls.jhipster] application with [PostgreSQL][urls.postgresql] database. Let's go!
...
<!--
     ...
     website/guides/tutorial/deploy-jhipster-with-postgresql.md.erb
-->
...
Get a copy of the sample source code of [JHipster sample project][urls.sample_jhipster_with_postgresql] by forking it.
...
To follow the guide, <a href="urls.sample_jhipster_with_postgresql">you can fork and use our repository</a>
...
<p align="center">
  <img src="/img/template-add-db.png" alt="Template DB JHipster" />
</p>
...
### Connect JHipster to PostgreSQL
...
To connect the JHipster app to the PostgreSQL database, you need to setup the application to use those secrets.

All you have to do is to open and edit [database configuration file][urls.sample_jhipster_with_postgresql_env_file] in your forked repository.
...
*TIP: you could also make use of **Variable Aliases** to change the name of used environment variables in your JHipster application. [Learn more here][docs.using-qovery.configuration.secret#alias-secret].*
...
Congratulations! Your environment with [JHipster][urls.jhipster] application and [PostgreSQL][urls.postgresql] database should be in progress.
...
[urls.jhipster]: https://www.jhipster.tech/
[urls.postgresql]: https://www.postgresql.org
[urls.qovery_chat]: https://discord.qovery.com
[urls.qovery_cli_releases]: https://github.com/Qovery/qovery-cli/releases
[urls.sample_jhipster_with_postgresql]: https://github.com/Qovery/simple-example-jhipster-with-postgresql
[urls.sample_jhipster_with_postgresql_env_file]: https://github.com/Qovery/simple-example-jhipster-with-postgresql/tree/master/src/main/resources/config
