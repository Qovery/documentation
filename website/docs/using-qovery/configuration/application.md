...
- Image tag: the tag of the image to be deployed with this application (example: 12). Note that this tag has to be unique and you cannot
- Image Entrypoint: the entrypoint to be used to launch your application (not mandatory)
- CMD Arguments: the arguments to be passed to launch your application (not mandatory). We expect the format to be an array. Example ["rails", "-h", "0.0.0.0", "-p", "8080", "string"]
