            ...
            <main>
                <section>
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="col">
                                <a href="https://github.com/qovery/documentation" target="_blank" className="panel panel--link text--center">
                                    <div className="panel--icon">
                                        <i className="feather icon-github"></i>
                                    </div>
                                    <div className="panel--title">Github qovery/documentation</div>
                ...
                <section>
                    <div className="container">
                        ...
                        <p>
                            Qovery is <a href="https://github.com/qovery/documentation">open-source</a> and welcomes contributions. A few
