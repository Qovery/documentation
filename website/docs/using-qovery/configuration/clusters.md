...
<p align="center">
  <img src="/img/configuration/clusters/organization-settings-access-button.jpg" alt="Application" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/add-cluster-button.jpg" alt="Application" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/create-cluster-window.jpg" alt="Application" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/set-resources-window-ec2.jpg" alt="Application" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/ready-to-install-window.jpg" alt="Ready to Install Window" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/add-cluster-button.jpg" alt="Add Cluster Button" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/create-cluster-window.jpg" alt="Create Cluster Window" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/set-resources-window-eks.jpg" alt="Set Resources For Your EKS Cluster Window" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/features-window.jpg" alt="Features Window" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/organization-settings-access-button.jpg" alt="Organization Access Button" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/cluster-settings-tab.jpg" alt="Cluster Settings Tab" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/more-options-cluster.jpg" alt="Display More Cluster Options" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/cluster-settings-access.jpg" alt="Cluster Settings Access" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/general-information-window.jpg" alt="General Information Window" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/editing-cluster-credentials.jpg" alt="Editing Cluster Credentials" />
</p>

The `Edit Credentials` window opens:

<p align="center">
  <img src="/img/configuration/clusters/edit-credentials.jpg" alt="Application" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/cluster-resources.jpg" alt="Cluster Resources Tab" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/instance-type-selection.jpg" alt="Instance Type Selection" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/instance-type-selection-helper.jpg" alt="Instance Type Selection Helper" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/more-options-cluster.jpg" alt="Cluster Actions Menu" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/cluster-update.jpg" alt="Cluster Update" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/update-cluster-confirmation.jpg" alt="Update Cluster Confirmation" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/stop-cluster.jpg" alt="Stop Cluster Window" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/stop-cluster-confirmation.jpg" alt="Stop Cluster Confirmation" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/restarting-cluster.jpg" alt="Restarting a Cluster" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/cluster-removal.jpg" alt="Cluster Removal" />
</p>
...
<p align="center">
  <img src="/img/configuration/clusters/delete-cluster-confirmation.jpg" alt="Delete Cluster Confirmation" />
</p>
...
<p align="center">
<img src="/img/configuration/clusters/access-infra-logs.jpg" alt="Cluster Log Option" />
</p>

A new windows is opened, displaying the logs of the cluster.

<p align="center">
<img src="/img/configuration/clusters/ok-infra-logs.jpg" alt="Cluster Log Option" />
</p>
...
<p align="center">
<img src="/img/configuration/clusters/error-infra-logs.jpg" alt="Cluster Log Option" />
</p>
...
```
 ...
 To do so, on your [Qovery Console][urls.qovery_console], access [your cluster options][docs.using-qovery.configuration.clusters#performing-actions-on-your-clusters] and click `Settings`:
  ...
  <p align="center">
  <img src="/img/configuration/clusters/cluster-settings-option.jpg" alt="Cluster Settings Option" />
</p>
...
In the `Remote Access` tab, enter your SSH key and click `Save`:
  ...
  <p align="center">
  <img src="/img/configuration/clusters/remote-access-tab.jpg" alt="Remote Access Tab" />
</p>
