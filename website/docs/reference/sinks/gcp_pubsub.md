...
authenticate access to the pubsub project and topic. If this is unset, Qovery
...
with the Qovery team by [opening an issue][urls.new_gcp_pubsub_sink_issue].
