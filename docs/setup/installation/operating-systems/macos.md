...
title: Install Qovery On MacOS
sidebar_label: MacOS
description: Install Qovery on MacOS
---
...
This document will cover installing Qovery on MacOS.
...
<Tabs
  ...
  select={false}
  size={null}
  values={[{"group":"Package managers","label":"Homebrew","value":"homebrew"},{"group":"Nones","label":"Qovery CLI","value":"qovery-cli"},{"group":"Platforms","label":"Docker CLI","value":"docker-cli"},{"group":"Platforms","label":"Docker Compose","value":"docker-compose"}]}>
