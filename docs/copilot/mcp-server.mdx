...
<CTABanner
  title="Manage your infrastructure and applications with natural language"
  subtitle="Ask Claude to list environments, check application status, tail logs, or trigger a deploy. All through Qovery's MCP Server. No kubectl needed."
