...
description: How to deploy a Gin application with the PostgreSQL database on AWS with Qovery
...
This tutorial show you how to deploy your [Gin][urls.gin] application with [PostgreSQL][urls.postgresql] database on [AWS][urls.aws]. Let's go!
...
## Steps to deploy Gin on AWS with Qovery
...
Get a local copy of the [Gin sample project][urls.sample_gin_with_postgresql] by forking it.

### Configure your project
To deploy your Gin application connected to a PostgreSQL, you need to have a `.qovery.yml` file, and a `Dockerfile` (both provided in the sample project) at the root of your project.
...
### Test the Gin application locally
...
## Conclusion
Congratulations! Now, you know how to deploy your Gin app with PostgreSQL on AWS in just a few steps.
