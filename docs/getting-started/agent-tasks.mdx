...
<Warning>
**Early Preview.** Agent Tasks is in early development and not yet generally available. Capabilities and setup will change before release. Want early access? Reach out to us directly in the product (help button in the console, or your dedicated Slack channel).
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Your Qovery Context, in One Click" icon="plug">
    Add your environments, services, and their configuration as context directly, alongside or instead of a Git repository, so the agent has the same view of your infrastructure you do.
  </Card>
