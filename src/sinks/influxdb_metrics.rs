...
mod tests {
    ...
    fn test_influxdb1_test_write_uri() {
        ...
        let uri = settings
            ...
            .unwrap();
        assert_eq!("http://localhost:8086/write?consistency=quorum&db=qovery_db&rp=autogen&p=secret&u=writer&precision=ns", uri.to_string())
    }
