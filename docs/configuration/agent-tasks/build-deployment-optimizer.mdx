...
- **Access**: give it access to the Qovery API, via the default read-only Qovery MCP server, or a Policy API token, to read and propose changes to the build/deploy configuration.
