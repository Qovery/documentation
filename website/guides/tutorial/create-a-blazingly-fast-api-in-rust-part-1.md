...
Most of the Rust REST API tests across the web are "[Hello World](https://medium.com/sean3z/rest-api-node-vs-rust-c75aa8c96343)" tests. They bench direct API I/O with no payload. It's very far from reality. Let's bench Rust with a simple **[Twitter](https://www.twitter.com) clone** API.

</Alert>

In this article, you will learn how to:

* To create a simple Twitter clone
* Implement a blazing fast REST API in Rust
* Connect it to a PostgreSQL database
* Test it with a very large number of queries
...
I am going to create a small part of their API to be able to post, read, and like tweets. The goal is to be able to use our twitter clone with a massive number of users simultaneously. Let's start to draft our API.
...
Our REST API needs to have 3 endpoints :
...
Now that I have defined our API, I am almost ready to code. Even though implementing an HTTP server could be fun, I choose to use [Actix](https://actix.rs/), which is ranked as [the most performant framework](https://www.techempower.com/benchmarks/#section=data-r18&hw=ph&test=fortune) ever by *Techempower*.
...
3 files structured our application.
