...
<CTABanner
  title="Your own Kubernetes cluster, ready in 30 minutes"
  subtitle="No cloud expertise needed. Qovery handles provisioning, upgrades, and guardrails. Free to start, no credit card required."
  button="Start free →"
/>
