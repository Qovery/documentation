...
<Steps>
  ...
  <Step title="Click Configure Portal">
    ...
    <Info>
    When you click **Configure Portal**, the portal automatically provisions a secure admin token encrypted with **AES-256-GCM**. This token allows the portal to perform privileged operations (cloning environments, managing deployments) on behalf of your users. It is never exposed to end users or visible in the portal UI.
    </Info>
  </Step>
