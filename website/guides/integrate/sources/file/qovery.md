...
description: "A simple guide to send logs from a file to another Qovery instance in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to Qovery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: qovery"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to another Qovery instance
...
<!--
     ...
     website/guides/integrate/sources/file/qovery.md.erb
-->
