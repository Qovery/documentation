...
title: Concepts
description: The fundamental Qovery concepts. A great place to start learning about Qovery.
---
...
It's worth getting familiar with the basic concepts that comprise Qovery as they
...
Qovery would be junk if it couldn't ingest data. A "source" defines where Qovery
...
Qovery. This might involve parsing, filtering, sampling, or aggregating. You can
...
All items (both logs and metrics) passing through Qovery are known as an
