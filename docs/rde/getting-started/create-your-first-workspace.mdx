...
<Check>Access to your organization's RDE Portal (URL provided by your admin)</Check>
<Check>A Qovery account — you log in via SSO with your existing Qovery credentials</Check>
...
<Steps>
  <Step title="Log in to the Portal">
    Open your portal URL (e.g., `https://rde.yourcompany.com`) and log in with your Qovery credentials. Authentication is handled through SSO — the same login you use for the Qovery Console.
  </Step>
