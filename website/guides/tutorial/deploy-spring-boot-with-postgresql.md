...
To follow the guide, <a href="urls.sample_spring_boot_with_postgresql">you can fork and use our repository</a>
...
### Connect your Spring Boot application to PostgreSQL
...
*TIP: you could also make use of **Variable Aliases** to change the name of used environment variables in your Spring Boot application. [Learn more here][docs.using-qovery.configuration.environment-variable#alias-environment-variable].*
