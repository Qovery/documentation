...
#### Get the Organization, Project, Environment and Application IDs
...
<p align="center">
  <img src="/img/how-to-integrate-qovery-with-github-actions/github_action_ids.png" alt="" />
</p>
...
- The organization / project / environment / application ids can be retrieved from the URL of your application (see below).
