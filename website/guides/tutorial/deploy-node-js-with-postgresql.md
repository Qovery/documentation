...
description: How to deploy a NodeJS application with the PostgreSQL database on AWS with Qovery
...
This tutorial show you how to deploy your [NodeJS][urls.node_js] application with [PostgreSQL][urls.postgresql] database on [AWS][urls.aws]. Let's go!
...
## Steps to deploy NodeJS on AWS with Qovery
...
## Conclusion
Congratulations! Now, you know how to deploy your NodeJS app with PostgreSQL on AWS in just a few steps.
