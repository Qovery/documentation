...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to another Qovery instance in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to Qovery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: qovery"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to another Qovery instance
...
<!--
     ...
     website/guides/integrate/sources/socket/qovery.md.erb
-->
...
For this guide, Qovery will receive data from
a TCP, UDP, or UDS socket via Qovery's
