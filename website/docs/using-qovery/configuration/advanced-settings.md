...
#### ![](/img/advanced_settings/application.svg) ![](/img/advanced_settings/container.svg) ![](/img/advanced_settings/cronjob.svg) ![](/img/advanced_settings/job.svg)
...
#### network.ingress.proxy_buffering ![](/img/advanced_settings/application.svg) ![](/img/advanced_settings/container.svg)

| Type   | Description                                                                              | Default Value |
|--------|------------------------------------------------------------------------------------------|---------------|
| string | Allows you to enable or disable nginx `proxy-buffering`. Valid values are `on` or `off`  | `on`          |

#### network.ingress.proxy_request_buffering ![](/img/advanced_settings/application.svg) ![](/img/advanced_settings/container.svg)
...
#### network.ingress.extra_headers ![](/img/advanced_settings/application.svg) ![](/img/advanced_settings/container.svg)
