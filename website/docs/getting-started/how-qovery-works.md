...
When it detects a Qovery configuration in your repository, it puts your application into a **CI/CD pipeline**.
<!---
TODO - IMAGE - GIT EVENTS?
-->
## Integrating Git and CI/CD
You don't need to set up your CI/CD (Continuous Integration and Continuous Deployment) pipeline. In response to Git events, we clone your repository and put it in the pipeline.
