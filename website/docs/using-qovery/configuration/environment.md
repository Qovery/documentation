...
Sometimes, you need to have a closer look on what is going on while an operation (see [Environment Statuses](docs.using-qovery.running-and-deployment-statuses#environment-statuses) is in progress.
