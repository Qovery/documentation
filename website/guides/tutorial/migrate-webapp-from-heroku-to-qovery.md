...
The application uses `DATABASE_URL` environment variable to connect to PostgreSQL. To provide your app
...
You should see the same application you previously deployed to Heroku, yet without *Todo* tasks you have added before.
...
In the browser, navigate to your application URL deployed on Qovery. You'll see all tasks you have previously added to the application hosted on Heroku. Well done!
