...
description: "The Qovery `file` sink streams `log` events to a file."
event_types: ["log"]
function_category: "transmit"
issues_url: https://github.com/qovery/documentation/issues?q=is%3Aopen+is%3Aissue+label%3A%22sink%3A+file%22
operating_systems: ["Linux","MacOS","Windows"]
sidebar_label: "file|[\"log\"]"
source_url: https://github.com/qovery/documentation/tree/master/src/sinks/file
status: "prod-ready"
title: "File Sink"
...
<Field
  ...
  defaultValue={null}
  enumValues={null}
  examples={["qovery-%Y-%m-%d.log","application-{{ application_id }}-%Y-%m-%d.log"]}
  groups={[]}
  name={"path"}
  path={null}
  relevantWhen={null}
...
Qovery will attempt to create the entire directory structure and the file when
emitting events to the file sink. This requires that the Qovery agent have
