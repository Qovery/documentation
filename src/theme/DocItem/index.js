        ...
        <div className="section">
            ...
            <div>
                <Link to="/docs/setup/installation/operating-systems/" title={`This component works on the ${operatingSystems.join(", ")} operating systems.`}>
                    ...
                    <OperatingSystemsStatus operatingSystems={operatingSystems} unsupportedOperatingSystems={unsupportedOperatingSystems}/>
                </Link>
            </div>}
        </div>
    );
                            ...
                            {!metadata.hide_title && (
                                <header>
                                    <div className="badges">
                                        {functionCategory &&
                                        <Link to={`/components?functions[]=${functionCategory}`} className="badge badge--primary">{functionCategory}</Link>}
                                    </div>
                        ...
                        <div className={classnames('table-of-contents', styles.tableOfContents)}>
                            ...
                            <div className="section">
                                ...
                                <ul className="contents">
                                    {editUrl && (<li>
                                        <a href={editUrl} className="contents__link" target="_blank"><i className="feather icon-edit-1"></i> Edit
                                            this page</a></li>)}
                                    {postsPath && (
                                        <li><Link to={postsPath} className="contents__link"><i className="feather icon-book-open"></i> View
                                            Blog Posts</Link></li>)}
                                    {issuesUrl && (<li>
                                        <a href={issuesUrl} className="contents__link" target="_blank"><i className="feather icon-message-circle"></i> View
                                            Issues</a></li>)}
                                    {sourceUrl && (<li>
                                        <a href={sourceUrl} className="contents__link" target="_blank"><i className="feather icon-github"></i> View
                                            Source</a></li>)}
                                </ul>
                            </div>
