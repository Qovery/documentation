...
An **application** is part of a project and is a container unit. Multiple applications can be part of the same [project][docs.using-qovery.configuration.project], be connected to a set of dependencies (databases and other services), and can communicate with other applications within the same project.
