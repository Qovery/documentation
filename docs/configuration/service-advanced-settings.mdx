...
<Warning>
On **Jobs** and **Cronjobs**, the toleration is not added. Setting `{"karpenter.sh/nodepool": "stable"}` on a job applies the affinity without the toleration, and its pods stay in `Pending`. Jobs and cronjobs are pinned to the dedicated `cronjob` node pool instead, with their toleration handled automatically.
</Warning>

<Info>
Applications and Containers are placed on the `stable` node pool automatically, affinity and toleration included, when the service has `min_instances` set to `1` or when it has storage attached. In those cases you do not need to set this advanced setting yourself.
</Info>
...
**Learn More:** See [Envoy Gateway HTTP Redirect Documentation](https://gateway.envoyproxy.io/docs/tasks/traffic/http-redirect/).
...
**Learn More:** See [Envoy Gateway CORS Documentation](https://gateway.envoyproxy.io/docs/tasks/security/cors/).
...
**Learn More:** See [Envoy Gateway IP Access Restriction Documentation](https://gateway.envoyproxy.io/docs/tasks/security/restrict-ip-access/).
...
**Learn More:** See [Envoy Gateway Basic Authentication Documentation](https://gateway.envoyproxy.io/docs/tasks/security/basic-auth/).
...
**Learn More:** See [Envoy Gateway Global Rate Limit Documentation](https://gateway.envoyproxy.io/docs/tasks/traffic/global-rate-limit/).
...
**Learn More:** See [Envoy Gateway HTTP Response Header Modifier Documentation](https://gateway.envoyproxy.io/docs/tasks/traffic/http-response-headers/).
...
**Learn More:** See [Envoy Gateway HTTP Request Header Modifier Documentation](https://gateway.envoyproxy.io/docs/tasks/traffic/http-request-headers/).
...
**Learn More:** See [Envoy Gateway Response Override Documentation](https://gateway.envoyproxy.io/docs/tasks/traffic/response-override/).
...
**Learn More:** See [Envoy Gateway Circuit Breaker Documentation](https://gateway.envoyproxy.io/docs/tasks/traffic/circuit-breaker/).
...
**Learn More:** See [Envoy Gateway TCPKeepalive API Reference](https://gateway.envoyproxy.io/v1.8/api/extension_types/#tcpkeepalive).
