...
description: "A simple guide to send logs from STDIN to another Qovery instance in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to Qovery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: qovery"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to another Qovery instance
...
<!--
     ...
     website/guides/integrate/sources/stdin/qovery.md.erb
-->
