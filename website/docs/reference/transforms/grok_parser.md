...
issues_url: https://github.com/qovery/documentation/issues?q=is%3Aopen+is%3Aissue+label%3A%22transform%3A+grok_parser%22
sidebar_label: "grok_parser|[\"log\"]"
source_url: https://github.com/qovery/documentation/tree/master/src/transforms/grok_parser.rs
status: "prod-ready"
...
The Qovery `grok_parser` transform
...
Qovery uses the Rust [`grok` library][urls.rust_grok_library]. All patterns
