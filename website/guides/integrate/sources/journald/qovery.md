...
description: "A simple guide to send logs from Journald to another Qovery instance in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to Qovery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: qovery"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to another Qovery instance
...
<!--
     ...
     website/guides/integrate/sources/journald/qovery.md.erb
-->
