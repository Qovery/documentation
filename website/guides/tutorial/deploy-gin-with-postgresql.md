...
In this blog post, I will show you how Qovery improves the developer experience to deploy staging and production [Gin][urls.gin] application with [PostgreSQL][urls.postgresql] database on Qovery. You will be able to focus on writing the best code instead of managing complex services.
...
### Gin sample application (Optional)
Get a local copy of the [Gin sample project][urls.sample_gin_with_postgresql] by forking the project.

### Configure your project
To deploy your Gin application connected to a PostgreSQL database, you need to have a `.qovery.yml` file, and a `Dockerfile` (provided in the sample project) at the root of your project.
