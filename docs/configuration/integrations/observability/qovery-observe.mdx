...
<Note>
This category is available for Applications, Containers, and Helm services when certificate renewal alerts are enabled. It is not available for databases or jobs.
</Note>
...
Choose a **Duration** of **Immediate**, **Last 1 minute**, **Last 5 minutes**, **Last 10 minutes**, **Last 15 minutes**, or **Last 30 minutes**. The one-hour renewal delay is part of the detection rule; the selected duration is the additional time the condition must remain true before the alert fires. Selecting **Immediate** removes only that additional wait.
