...
<CTABanner
  title="Your entire infrastructure, one terminal command away"
  subtitle="Deploy, manage, and monitor without ever opening a Kubernetes dashboard. Qovery turns complex cluster operations into simple CLI calls."
