...
function Command({format, path, source, sink}) {
    ...
    return (
        <>
            ...
            <CodeExplanation>
                <ul>
                    <li>The <Link to={`/docs/reference/sources/${source.name}/`}><code>{source.name}</code> source</Link> ingests {source.through_description}.
                    </li>
                    <li>The <Link to={`/docs/reference/sinks/${sink.name}/`}><code>{sink.name}</code> sink</Link> writes
                        to {sink.write_to_description}.
                    </li>
                    <li>The <code>{path}</code> file is the <Link to="/docs/setup/configuration/">Qovery configuration file</Link> that
                        Qovery uses in the next step.
                    </li>
                </ul>
            </CodeExplanation>
        </>
