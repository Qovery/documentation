...
description: "A simple guide to send logs from Splunk HEC to another Qovery instance in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to Qovery Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: qovery"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to another Qovery instance
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/qovery.md.erb
-->
